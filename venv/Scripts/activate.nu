...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\hp\grid_fs_service\mongodb_grid_fs_service\venv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\hp\grid_fs_service\mongodb_grid_fs_service\venv\Scripts\deactivate.nu'
